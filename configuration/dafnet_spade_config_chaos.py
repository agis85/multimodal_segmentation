...
params = {
    ...
    'model': 'dafnet.DAFNet',                         # model to load
    'executor': 'dafnet_executor.DAFNetExecutor',     # model trainer
    'l_mix': 1,                                       # amount of supervision for target modality
    'decoder_type': 'spade',                           # decoder type - can be film or spade
    'num_z': 8,
    'w_sup_M': 10,
    'w_adv_M': 1,
    'w_rec_X': 1,
    ...
    'lr': 0.0001,
    'randomise': False,
    'automatedpairing': False,
}

# discriminator configs
d_mask_params  = {'filters': 64, 'lr': 0.0001, 'name': 'D_Mask', 'downsample_blocks': 4}
d_image_params = {'filters': 64, 'lr': 0.0001, 'name': 'D_Image', 'downsample_blocks': 4}
